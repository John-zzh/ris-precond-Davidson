...
def Davidson (k, tol, initial_guess, preconditioner):
    ...
    print ('Number of calls for A*v =', np.shape(sub_A)[0])
...
#     print ('Number of excited states =', e)
#     Excitation_energies, kets = Davidson (e, tol, initial_guess, preconditioner)
