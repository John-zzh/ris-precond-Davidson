...
# def _contract_xc_kernel(td_grad, xc_code, dmvo, dmoo=None, with_vxc=True, with_kxc=True, singlet=True, max_memory=2000):
#     mol = td_grad.mol
#     # mf = td_grad.base._scf
#     grids = mf.grids
#
...
if __name__ == '__main__':
    ...
    mol.atom = 'C         -4.89126        3.29770        0.00029; \
